...
const sampleStructure: Structure = {
  ...
  parking_car_slots: 10,
  parking_bus_slots: 2,
  parking_notes: "Parcheggio accanto all'ingresso",
  accessibility_notes: "Rampe disponibili",
  ...
  usage_rules: "Silenzio dopo le 23",
  animal_policy: "allowed_on_request",
  animal_policy_notes: "Solo animali di piccola taglia",
  in_area_protetta: false,
  ente_area_protetta: null,
  environmental_notes: "Rispettare la raccolta differenziata",
  seasonal_amenities: null,
