...
- Gli stessi endpoint impostano `Cache-Control: public, max-age=120, stale-while-revalidate=600` per suggerire ai client una cache breve con rivalidazione in background.
