...
- ✅ Run the automated axe smoke suite (`npm test`) before opening a pull request. Fix any critical violations immediately.
  - ℹ️ The Vitest runner powers these checks; use `npm test -- --run` if you need to serialize execution while reproducing axe findings locally.
