...
def search_structures(
    ...
    province: Annotated[str | None, Query(min_length=2, max_length=2)] = None,
    structure_type: Annotated[StructureType | None, Query(alias="type")] = None,
    season: Annotated[StructureSeason | None, Query()] = None,
    unit: Annotated[StructureUnit | None, Query()] = None,
    cost_band: Annotated[CostBand | None, Query()] = None,
    max_km: Annotated[float | None, Query(gt=0)] = None,
    access: Annotated[str | None, Query()] = None,
    fire_policy: Annotated[FirePolicy | None, Query(alias="fire")] = None,
    ...
    min_power_capacity_kw: Annotated[float | None, Query(ge=0)] = None,
    min_parking_car_slots: Annotated[int | None, Query(ge=0)] = None,
    flood_risk: Annotated[FloodRiskLevel | None, Query()] = None,
    open_in_season: Annotated[StructureOpenPeriodSeason | None, Query()] = None,
    open_on_date: Annotated[date | None, Query()] = None,
    page: Annotated[int, Query(ge=1)] = 1,
    page_size: Annotated[int, Query(ge=1, le=100)] = 20,
    sort: Annotated[str, Query()] = DEFAULT_SORT_FIELD,
    order: Annotated[str, Query()] = DEFAULT_SORT_ORDER,
    *,
    request: Request,
    response: Response,
