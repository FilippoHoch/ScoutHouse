...
async def search_geocoding(
    *,
    address: str | None = Query(default=None, max_length=255),
    locality: str | None = Query(default=None, max_length=255),
    municipality: str | None = Query(default=None, max_length=255),
    province: str | None = Query(default=None, max_length=100),
    postal_code: str | None = Query(default=None, max_length=16),
    country: str | None = Query(default="IT", min_length=2, max_length=2),
